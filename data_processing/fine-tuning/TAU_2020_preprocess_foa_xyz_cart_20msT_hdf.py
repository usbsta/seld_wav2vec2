...
def finetuning_preprocess_data_tau2020(cfg: DictConfig) -> None:
    ...
    if spec_transform is not None:
        save_folder = f"{params['save_folder']}/tau_nigens_2020_foa_ft_val_split_xyz_cart_20mst_spec_hdf"
        manifest_folder = f"{params['manifest_folder']}/tau_nigens_2020_foa_ft_val_split_xyz_cart_20mst_spec_hdf"
    else:
        save_folder = f"{params['save_folder']}/tau_nigens_2020_foa_ft_val_split_xyz_cart_20mst_hdf"
        manifest_folder = f"{params['manifest_folder']}/tau_nigens_2020_foa_ft_val_split_xyz_cart_20mst_hdf"
