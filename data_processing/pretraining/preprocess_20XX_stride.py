...
from seld_data_processing.save_waves import save_wav_for_dataset
...
def preprocess_audio_waves(
    ds_tag, data_path, save_path, fs_target, Ts, stride, exclude_mic=False
):
    ...
    if ds_tag == "tut_2018":
        ...
        data_dict = {
            f"{data_path}/TUT_2018/ANSYN": "ANSYN",
        ...
        if exclude_mic:
            data_dict = {
                f"{data_path}/TAU_2019/foa_dev": "foa_dev",
        ...
        if exclude_mic:
            data_dict = {
                f"{data_path}/TAU_2020/foa_dev": "foa_dev",
        ...
        if exclude_mic:
            data_dict = {
                f"{data_path}/TAU_2021/foa_dev": "foa_dev",
        ...
        data_dict = {
            f"{data_path}/L3DAS21/L3DAS_Task1_dev": "L3DAS_Task1_dev",
            f"{data_path}/L3DAS21/L3DAS_Task1_test": "L3DAS_Task1_test",
            f"{data_path}/L3DAS21/L3DAS_Task1_train100": "L3DAS_Task1_train100",
            f"{data_path}/L3DAS21/L3DAS_Task1_train360": "L3DAS_Task1_train360",
            f"{data_path}/L3DAS21/L3DAS_Task2_dev": "L3DAS_Task2_dev",
            f"{data_path}/L3DAS21/L3DAS_Task2_test": "L3DAS_Task2_test",
            f"{data_path}/L3DAS21/L3DAS_Task2_train": "L3DAS_Task2_train",
        }
        ...
        data_dict = {
            f"{data_path}/L3DAS22/L3DAS22_Task1_dev": "L3DAS22_Task1_dev",
            f"{data_path}/L3DAS22/L3DAS22_Task1_test": "L3DAS22_Task1_test",
            f"{data_path}/L3DAS22/L3DAS22_Task1_train100": "L3DAS22_Task1_train100",
            f"{data_path}/L3DAS22/L3DAS22_Task1_train360_1": "L3DAS22_Task1_train360_1",
            f"{data_path}/L3DAS22/L3DAS22_Task1_train360_2": "L3DAS22_Task1_train360_2",
            f"{data_path}/L3DAS22/L3DAS22_Task2_dev": "L3DAS22_Task2_dev",
            f"{data_path}/L3DAS22/L3DAS22_Task2_test": "L3DAS22_Task2_test",
            f"{data_path}/L3DAS22/L3DAS22_Task2_train": "L3DAS22_Task2_train",
        }
    ...
    for ds_path, ds_name in data_dict.items():
        wav_files = glob.glob(f"{ds_path}/**/*.wav", recursive=True)

        assert len(wav_files) > 0, f"{ds_path}"

        logger.info(f"pre-processing {len(wav_files)} files")

        save_wav_for_dataset(
            ds_wav_files=wav_files,
        ...
        saved_foa_wav_files = glob.glob(f"{save_folder}/**/*.wav", recursive=True)
