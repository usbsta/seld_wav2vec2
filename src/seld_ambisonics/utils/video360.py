...
import math
import numpy as np
from seld_ambisonics.common import spherical_harmonics_matrix


def overlay_map(audio_fn, video_fn, output_fn):
    from seld_ambisonics.iolib.video import VideoReader, VideoWriter
    from seld_ambisonics.iolib.audio import AudioReader
    from seld_ambisonics.distance import SphericalAmbisonicsVisualizer
    import tempfile
...
class AmbiPower:
    def __init__(self, pos):
        ...
        from seld_ambisonics.position import Position
...
def ambix_power_map(ambix, audio_rate=22050, outp_rate=10, angular_res=5.0):
    from seld_ambisonics.distance import spherical_mesh
    from seld_ambisonics.decoder import AmbiDecoder, AmbiFormat
    from seld_ambisonics.position import Position
...
if __name__ == '__main__':
    from seld_ambisonics.iolib.audio import AudioReader, AudioWriter
    from seld_ambisonics.position import Position
    from math import pi
